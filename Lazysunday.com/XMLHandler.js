...
function createURL() {
    ...
    var _clientId = "&client_id=API KEY"; // API key removed
...
function loadDoc() {
    ...
    xhttp.open("GET", "https://api.seatgeek.com/2/recommendations?events.id=1162104&postal_code=28209&client_id=API KEY&format=xml", true);
    xhttp.send();
}
